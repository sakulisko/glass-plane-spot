...
import com.google.android.glass.sample.compass.App;
...
public class Landmarks {
     ...
     */
    private static final double MAX_DISTANCE_KM = Double.MAX_VALUE;
...
//        populatePlaceList(jsonString);
       for (Flight fl : App.getFlights()) {
          mPlaces.add(new Place(fl.getLatitude(), fl.getLongitude(), fl.getPath()));
       }
    }
